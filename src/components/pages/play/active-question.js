...
const ActiveQuestion = ({ cookie, game, game: { active }, handleClick, io, updateCookie }) => {
        ...
        cookie !== game.host.id &&
          (
            Array.isArray(active.answer)
              ? <AnswerSelection {...{ active, cookie, io, updateCookie }} />
              : <AnswerForm {...{ cookie, io, updateCookie }} />
          )
      }

      <div className='question'>
        {game.questions.length + 1}. {active.question}
      </div>
